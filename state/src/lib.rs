...
//! ## Referring to files
//!
//! This crate also includes features to create files in a unique namespace for the plugin instance. However, these files will not persist across `save`/`restore` calls and therefore need to be saved together with the state as well. For more information, see the documentation of the [`path` module](path/index.html).
//!
//! ## Example usage
//!
//! ```
